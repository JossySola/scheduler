...
export default function Frame_Table ({ lang }: {
    lang: "en" | "es"
}) {
    return (
        <div className="bg-white rounded-xl grid grid-cols-[150px_1fr] gap-4 p-8 w-fit h-fit shadow-xl">
            ...
            <div aria-label="sample-table" className="col-start-2 row-start-2 w-[286px] overflow-hidden flex flex-col gap-2">
                <div className="flex flex-row gap-2 pl-[15px] w-fit">
                    <div className="text-tiny font-bold w-[155.88px] text-center">A</div>
                    <div className="text-tiny font-bold w-[155.88px] text-center">B</div>
                    <div className="text-tiny font-bold w-[155.88px] text-center">C</div>
                </div>
                <div aria-label="sample-row" className="flex flex-row items-center gap-2 w-[500px]">
                    <span className="text-tiny font-bold">0</span>
                    
                    <div aria-label="sample-input-wrapper" className="relative inline-flex tap-highlight-transparent flex-row items-center shadow-sm px-3 gap-3 bg-default-100 data-[hover=true]:bg-default-200 group-data-[focus=true]:bg-default-100 min-h-10 rounded-medium transition-background motion-reduce:transition-none !duration-150 outline-none group-data-[focus-visible=true]:z-10 group-data-[focus-visible=true]:ring-2 group-data-[focus-visible=true]:ring-focus group-data-[focus-visible=true]:ring-offset-2 group-data-[focus-visible=true]:ring-offset-background w-[200px] h-[40px] is-filled">
                ...
                <div aria-label="sample-row" className="flex flex-row items-center gap-2 w-[730px]">
                    ...
                    <div aria-label="sample-header-input-wrapper" className="relative inline-flex tap-highlight-transparent flex-row items-center shadow-sm px-3 gap-3 bg-default-100 data-[hover=true]:bg-default-200 group-data-[focus=true]:bg-default-100 min-h-10 rounded-medium transition-background motion-reduce:transition-none !duration-150 outline-none group-data-[focus-visible=true]:z-10 group-data-[focus-visible=true]:ring-2 group-data-[focus-visible=true]:ring-focus group-data-[focus-visible=true]:ring-offset-2 group-data-[focus-visible=true]:ring-offset-background w-[155.88px] h-[40px] is-filled">
