            ...
            <section className="p-10 pb-[6rem] text-base/7 h-fit">
                ...
                <ul className="pl-4 list-disc">
                    <li>
                        ...
                        <i>Para más información, visita: <a href={`/${lang}/delete-my-data`} target="_blank">Eliminar mis datos</a></i>
                    </li>
                ...
                <p>Si tienes alguna pregunta sobre esta Política de Privacidad, por favor contáctanos {<Link href={`/${lang}/contact`}>aquí</Link>}.</p>
                <Divider className="my-4"/>
        ...
        <section className="p-10 pb-[6rem] text-base/7 h-fit">
            ...
            <ul className="pl-4 list-disc">
                <li>
                    ...
                    <i>For more information, visit: <a href={`/${lang}/delete-my-data`} target="_blank">Delete My Data</a></i>
                </li>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us {<Link href={`/${lang}/contact`}>here</Link>}.</p>
            <Divider className="my-4"/>
            <footer className="text-tiny dark:bg-[#1A1A1A]" id="footer">
