            ...
            <section className="p-10 pb-[6rem] text-base/7 h-fit">
                ...
                <ul className="pl-4 list-disc">
                    <li>
                        ...
                        <i>Para más información, visita: <a href={`${process.env.NEXT_PUBLIC_ORIGIN}/${lang}/delete-my-data`} target="_blank">Eliminar mis datos</a></i>
                    </li>
                ...
                <p>Si tienes alguna pregunta sobre esta Política de Privacidad, por favor contáctanos {<Link href={`${process.env.NEXT_PUBLIC_ORIGIN}/${lang}/contact`}>aquí</Link>}.</p>
                <Divider className="my-4"/>
