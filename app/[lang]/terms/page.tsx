...
export default async function Page ({ params }: {
    ...
    if (lang === "es") {
        return (
            <section className="p-10 pb-24 text-base/7 h-fit">
                ...
                <p>Si tienes preguntas o inquietudes sobre estos términos, contáctanos {<Link href={`/${lang}/contact`}>aquí</Link>}.</p>
                <Divider className="my-4"/>
    ...
    return (
        <section className="p-10 pb-24 text-base/7 h-fit">
            ...
            <p>If you have any questions or concerns about these terms, please contact us {<Link href={`/${lang}/contact`}>here</Link>}.</p>
            <Divider className="my-4"/>
            <footer className="text-tiny dark:bg-[#1A1A1A]" id="footer">
