      ...
      <>
        ...
        <footer className="text-[#27272a] dark:text-[#f4f4f5] dark:bg-[#27272A] flex flex-col justify-start items-start gap-2 w-full h-fit bg-[#F4F4F5] bottom-0 p-10 pb-20 sm:grid sm:grid-cols-[auto_3px_auto]">
            <ul className="m-3 sm:col-start-1">
              ...
              <li id="legal-2" className="flex flex-row gap-3 justify-start items-start mb-2"><span className="text-tiny">2</span>{ lang === "es" ? <span className="text-tiny">La opción de uso de Inteligencia Artificial es habilitado con el modelo Claude 3 Opus de la empresa Anthropic. Al usar esta opción estarás de acuerdo con sus <Link href="https://www.anthropic.com/legal/consumer-terms">Términos de Uso</Link>. Aunque continuamente buscamos nuevas formas para mejorar el resultado de la IA desde nuestra aplicación, no garantizamos la precisión, fiabilidad o eficacia de la respuesta generada por la Inteligencia Artificial.</span> : <span className="text-tiny">The Artificial Intelligence feature is provided by Anthropic through Claude 3 Opus AI Model. By using this feature you agree with their <Link href="https://www.anthropic.com/legal/consumer-terms">Terms of Service</Link>. Even though we continuously look for better ways to improve the AI's output from our end, we do not guarantee the accuracy, reliability, or effectiveness of the AI generated output.</span> }</li>
